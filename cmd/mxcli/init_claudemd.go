...
func generateClaudeMD(projectName, mprFile string) string {
	...
	w("Every skill is a " + bt + "<name>/SKILL.md" + bt + " directory with a " + bt + "description" + bt + " in its frontmatter (the\n")
	...
	// ── Skills Reference ────────────────────────────────────────────
	w("## Skills Reference\n\n")
	w("Skills are in " + bt + ".ai-context/skills/<name>/SKILL.md" + bt + " (and " + bt + ".claude/skills/" + bt + " for Claude\n")
	...
	w("## MDL Reference\n\n")
	w("For detailed MDL syntax, see the skill files in " + bt + ".ai-context/skills/<name>/SKILL.md" + bt + ".\n")
