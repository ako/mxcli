...
| Statement | Description |
|-----------|-------------|
| [DESCRIBE ENTITY](describe-entity.md) | Show complete MDL source for an entity |
| [DESCRIBE ASSOCIATION](describe-association.md) | Show association details |
...
| Statement | Description |
|-----------|-------------|
| [SEARCH](search.md) | Full-text search across all project strings and source |
