...
| 2026-05-27 | models/storage-vs-qualified-names.md | CLAUDE.md, sdk/mpr/parser_microflow.go, sdk/mpr/writer_odata.go, sdk/mpr/parser_odata.go | Reflect 2026-05-27 OData session: qualified attribute/association field keys, single-field microflow dropdown, RemoteName-preservation executor pattern. Extended scope from `$Type` storage names to also cover field-key qualified names, version-renamed keys, and single-field-with-sub-document-discriminator dropdowns |
| 2026-05-27 | bug-patterns/visitor-wiring-gaps.md | .claude/skills/fix-issue.md, mdl/visitor/visitor_enumeration.go, mdl/executor/cmd_odata.go, mdl/ast/ast_odata.go | Reflect 2026-05-27 OData session: qualified attribute/association field keys, single-field microflow dropdown, RemoteName-preservation executor pattern. Added the executor `or modify` overwrite variant (#594) as a sibling of the visitor parsed-but-not-stored pattern, with `*string`/`*bool` AST fields as the canonical workaround |
